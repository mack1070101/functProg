    ...
    (t
      (let ( (f (car E))  (arg (cdr E)) (V (getValues E)))
        (cond
          ...
          ((eq f 'if) (if (flInterpHelper (car arg) P) (flInterpHelper (cadr arg) P) (flInterpHelper (caddr arg) P)))
          ((eq f 'null) (NULL (car arg)))
          ((eq f 'atom) (ATOM (car arg)))
          ((eq f 'eq) (eq (flInterpHelper (car arg) P) (flInterpHelper (cdr arg) P)))
          ((eq f 'first)  (car (flInterpHelper (car arg) P)))
          ((eq f 'rest) (cdr (flInterpHelper (car arg) P)))
          ((eq f 'cons) (cons (flInterpHelper (car arg) P) (flInterpHelper (cadr arg) P)) )
          ((eq f 'equal) (equal (flInterpHelper (car arg) P) (flInterpHelper (cadr arg) P)))
          ((eq f 'isnumber) (numberp (flInterpHelper (car arg) P)))
          ((eq f '+) (+ (flInterpHelper (car arg) P) (flInterpHelper (cadr arg) P)))
          ((eq f '-) (- (flInterpHelper (car arg) P) (flInterpHelper (cadr arg) P)))
          ((eq f '*) (* (flInterpHelper (car arg) P) (flInterpHelper (cadr arg) P)))
          ((eq f '>) (> (flInterpHelper (car arg) P) (flInterpHelper (cadr arg) P)))
          ((eq f '<) (< (flInterpHelper (car arg) P) (flInterpHelper (cadr arg) P)))
          ((eq f '=) (= (flInterpHelper (car arg) P) (flInterpHelper (cadr arg) P)))
          ((eq f 'and) (and (flInterpHelper (car arg) P) (flInterpHelper (cadr arg) P)))
          ((eq f 'or) (or (flInterpHelper (car arg) P) (flInterpHelper (cadr arg) P)))
          ((eq f 'not) (not (flInterpHelper (car arg) P)))
          ; Handle user defined functions
          ((atom f)
            ;something like ((lambda (vals) ((flInterpHelper (buildExpr B N vals nil) P))) findvalssomehow)
             (flInterpHelper (buildExpr B N V nil) P)
          )
          (t  E)
          )
        )
